...
inline std::size_t matchSFC(const long param) {
    ...
    if (matchAny(param, 8, 9, range(15, 18), 20, range(26, 45), 47, 50, 57, 58, 66, 67, 74, 129, 134, 139,
                 ...
                 range(235033, 235038), range(235041, 235043), 235048, 235051, 235052, 235055, 235058, 235238,
...
inline std::size_t matchSOL(const long param) {
    ...
    if (matchAny(param, 33, 74, 238, 228038, 235406, 237406, 238406, 239406, 228141, 235078, 237078, 238078, 239078,
